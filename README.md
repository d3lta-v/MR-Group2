...
- Navigation
    ...
    - Data Processing
        - Lane image to CTE and relative angle unit (`cte` and `omega_rel`): This unit transforms processed lane images into an estimated CTE (centre track error) and relative angle to the lane. 
- Guidance
