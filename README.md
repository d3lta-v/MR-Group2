...
- Guidance
    ...
    - **DirectionalGuidancePackage**: Computes the bird's eye view image of the lane to CTE (centre track error) and relative angle unit (`cte` and `omega_rel`), and feeds it to the motion PID controller.
